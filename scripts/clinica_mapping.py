...
NOTE: The ADNIMERGE.csv file is downloaded from the ADNI website. The original CSV file has a DX column (labels) with 
missing values, the ADNIMERGE.csv included in this repository contains imputed values based on previous visits and 
DX_base.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_proc",
                        default=NUM_CPU - 1,
                        type=int,
                        help=f"Maximum number of parallel processes to spawn, set to #CPU - 1 by default. Set to 1 for "
                             f"debugging.")
